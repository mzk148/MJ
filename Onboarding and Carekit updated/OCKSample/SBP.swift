...
/**
 ...
 assessment.
 */
struct SBP: Assessment {
    // MARK: Activity
    
    let activityType: ActivityType = .SBP
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let thresholds = [OCKCarePlanThreshold.numericThreshold(withValue: NSNumber.init(value: 140), type: .numericGreaterThanOrEqual, upperValue: nil, title: "Take a medication")] as Array<OCKCarePlanThreshold>;
        
        // Get the localized strings to use for the assessment.
        let title = NSLocalizedString("SBP", comment: "")
        let summary = NSLocalizedString("Systolic blood pressure", comment: "")
    ...
    func task() -> ORKTask {
        ...
        // Create a question.
        let title = NSLocalizedString("Measure your systolic blood pressure.", comment: "")
