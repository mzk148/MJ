//
//  NurseVisitDepressionSurvey.swift
//  OCKSample
//
...
public var NurseVisitDepressionSurveyTask: ORKOrderedTask {
    
    var steps = [ORKStep]()
    
    let instStep = ORKInstructionStep(identifier: "Instruction Step")
    instStep.title = "PHQ9 Depression Questions"
    instStep.detailText = "This survey demonstrates different question types about the level of depression that you're currently experiencing."
    steps += [instStep]
...
{
    func processNurseVisitDepressionSurveyResults(_ taskResult: ORKTaskResult?)
    {
