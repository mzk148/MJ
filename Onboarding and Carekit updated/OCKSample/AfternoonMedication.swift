...
/**
 ...
 medication.
 */
struct AfternoonMedication: Assessment {
    // MARK: Activity
    
    let activityType: ActivityType = .afternoonMedication
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Afternoon Medication", comment: "")
    ...
    func task() -> ORKTask {
        ...
        // Create a question.
        let question = NSLocalizedString("How many medications did you take in this afternoon?", comment: "")
