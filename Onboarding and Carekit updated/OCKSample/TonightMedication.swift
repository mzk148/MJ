...
/**
 ...
 medication.
 */
struct TonightMedication: Assessment {
    // MARK: Activity
    
    let activityType: ActivityType = .tonightMedication
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Tonight Medication", comment: "")
    ...
    func task() -> ORKTask {
        ...
        // Create a question.
        let question = NSLocalizedString("How many medications did you take tonight?", comment: "")
