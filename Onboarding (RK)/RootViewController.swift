...
/*class RootViewController: UITabBarController {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        onboardingViewController = createOnboardingViewController()
    ...
    fileprivate func createInsightsViewController() -> OCKInsightsViewController {
        ...
        let activityType11: ActivityType = .DBP
        let _: ActivityType = .appetite
        let _: ActivityType = .diuretic
        let _: ActivityType = .betaBlocker
        let _: ActivityType = .ACEInhibitor
        let _: ActivityType = .ARB
        let _: ActivityType = .potassium
        let _: ActivityType = .digoxin
        let _: ActivityType = .fitness
        let _: ActivityType = .minnesota
        let _: ActivityType = .isosorbideDinitrate
        let _: ActivityType = .sodium
        let _: ActivityType = .fat
        ...
        let widget2 = OCKPatientWidget.defaultWidget(withActivityIdentifier: activityType10.rawValue, tintColor: OCKColor.red)
        let widget3 = OCKPatientWidget.defaultWidget(withActivityIdentifier: activityType11.rawValue, tintColor: OCKColor.red)
        
        
        let viewController = OCKInsightsViewController(insightItems: storeManager.insights, patientWidgets: [widget1, widget2, widget3], thresholds: [activityType1.rawValue, activityType4.rawValue, activityType5.rawValue, activityType6.rawValue, activityType7.rawValue, activityType8.rawValue, activityType9.rawValue, activityType10.rawValue, activityType11.rawValue], store:storeManager.store)
